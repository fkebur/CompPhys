...
class SiteSampler(_object):
    ...
    def __init__(self, *args): 
        this = _dla.new_SiteSampler(*args)
        try: self.this.append(this)
        except: self.this = this
    def sample(self, *args) -> "unsigned int" : return _dla.SiteSampler_sample(self, *args)
    def size(self) -> "unsigned int" : return _dla.SiteSampler_size(self)
...
class CPP11Random(_object):
    ...
    def __call__(self) -> "double" : return _dla.CPP11Random___call__(self)
